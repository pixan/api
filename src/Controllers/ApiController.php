<?php
namespace Pixan\Api\Controllers;
...
class ApiController extends Controller
{
	...
	public function respondWithException($exception){
		$this->setMessages([$exception->getMessage(), $exception->getFile(), strval($exception->getLine())]);
		return $this->setStatusCode(SymfonyResponse::HTTP_INTERNAL_SERVER_ERROR)->respond();
	}
